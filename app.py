...
def range_slider():
    ...
    scale_im.save(os.path.abspath("static/scale_image.jpeg"))
    # print(ela_im)
...
def fela():
    ...
    mp = load_model(os.path.abspath('model/model_C2_e50_14000.h5'))
    # import pickle
    # with open(os.path.abspath('model/model_pickle_C2_e40_12000'),'rb') as f:
    #     mp = pickle.load(f)
